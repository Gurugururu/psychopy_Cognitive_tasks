...
nextButton = visual.Rect(win, name="nextButton", width=0.12, height =0.05, pos=(buttonX,buttonY))
...
for i in range(2):
    ...
    trialComponents = [statement1, statement2, statement3, slider1, slider2, slider3, slider4, sliderS1, sliderS2, sliderS3, sliderS4, sliderV1, sliderV2, sliderV3, sliderV4, nextButton, nextText, stateBox]
